    ...
    <div class="container">
      <div class="row">
        <div>
          ...
          $consulta = $mysqli->query("SELECT * FROM Project p LEFT JOIN Departamento de USING (idDepartamento) WHERE p.idProyecto = $getID");
          ...
          while ($fila = mysqli_fetch_array($consulta)) {
            ...
            $descripcion = rawurlencode($fila['descripcionProyecto']);
            ...
            if ($fila['fileProyecto'] != null) {
              echo "<br/> <a href='assets/img/project/files/" . $fila['fileProyecto'] . "'> Ver PDF </a>";
            }
